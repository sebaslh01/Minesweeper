...
public class ActivateBlowUpActionTests {
	 ...
	 * WHEN: activate() the action of a tile with mine
	 * THEN: Board is markAsExploded
	 */
	@Test
	public void tileWithMine() {
		Action action = new BlowUpAction(board);
		sq1.setAction(action);
		sq1.stepOn();
